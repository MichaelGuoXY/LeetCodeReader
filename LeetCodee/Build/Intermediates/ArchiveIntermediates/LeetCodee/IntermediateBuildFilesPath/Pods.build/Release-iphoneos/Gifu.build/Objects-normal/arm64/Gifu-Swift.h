...
/**
  Example class that conforms to \code
  GIFAnimatable
  \endcode. Uses default values for the animator frame buffer count and resize behavior. You can either use it directly in your code or use it as a blueprint for your own subclass.
*/
...
@interface UIImageView (SWIFT_EXTENSION(Gifu))
@end
